...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    List<ContatosBEAN> listaDeContatos;
    ...
    public void atualizaTabelaContatos() throws SQLException {
        ...
        listaDeContatos = controle.listaContatos();

        DefaultTableModel modelo = new DefaultTableModel(new Object[]{"ID", "Nome", "Apelido", "Data nasc."}, 0);

        for (int i = 0; i < listaDeContatos.size(); i++) {
            modelo.addRow(new Object[]{listaDeContatos.get(i).getId(), listaDeContatos.get(i).getNome(), listaDeContatos.get(i).getApelido(), listaDeContatos.get(i).getData_nascimento()});
        }
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        if (index >= 0 && tabelaContatos.getSelectedRow() < listaDeContatos.size()) {
            ContatosBEAN contatoSelecionado = listaDeContatos.get(tabelaContatos.getSelectedRow());
            try {
    ...
    private void tabelaContatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaContatosMouseClicked
        ...
        if (index >= 0 && tabelaContatos.getSelectedRow() < listaDeContatos.size()) {
            ...
            ContatosBEAN contato = listaDeContatos.get(index);
